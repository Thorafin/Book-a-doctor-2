...
<meta charset="utf-8">
    ...
    <style><%@include file="/static/css/animate.css"%></style>
...
<section>
	<div class="w-80">
     <div class="form-box">
		...
		<div class="animated flash">
			<img src="static/images/2.jpg" width="100%" height="100%">
		</div>
		<div class="animated flash">
			<img src="static/images/3.jpg" width="100%" height="100%">
		</div>
		<div class="animated flash">
			<img src="static/images/4.jpg" width="100%" height="100%">
		</div>
	    </div>
        
        <div class="gallery">
		<div class="animated flash">
			<img src="static/images/5.jpg" width="100%" height="100%">
		</div>
		<div class="animated flash">
			<img src="static/images/6.jpg" width="100%" height="100%">
		</div>
		<div class="animated flash">
			<img src="static/images/7.jpg" width="100%" height="100%">
		</div>
		<div class="animated flash">
			<img src="static/images/8.jpg" width="100%" height="100%">
		</div>
	    </div>

        <div class="gallery">
		<div class="animated flash">
			<img src="static/images/9.jpg" width="100%" height="100%">
		</div>
		<div class="animated flash">
			<img src="static/images/2.jpg" width="100%" height="100%">
		</div>
